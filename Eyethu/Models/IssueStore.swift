    ...
    private func loadMockData() {
        ...
        issues = [
            Issue(id: 1, type: .pothole,
                  ...
                  createdAt: cal.date(byAdding: .hour, value: -2, to: now)!, photos: nil, reportLocations: nil),
            Issue(id: 2, type: .waterLeak,
                  ...
                  createdAt: cal.date(byAdding: .day, value: -1, to: now)!, photos: nil, reportLocations: nil),
            Issue(id: 3, type: .streetlight,
                  ...
                  createdAt: cal.date(byAdding: .day, value: -5, to: now)!, photos: nil, reportLocations: nil),
            Issue(id: 4, type: .powerOutage,
                  ...
                  reportLocations: [
                    ReportLocation(lat: -26.2021, lon: 28.0493),
                    ReportLocation(lat: -26.2025, lon: 28.0498),
                    ReportLocation(lat: -26.2018, lon: 28.0489),
                    ReportLocation(lat: -26.2030, lon: 28.0505),
                    ReportLocation(lat: -26.2015, lon: 28.0490)
                  ]),
            Issue(id: 5, type: .pothole,
                  ...
                  createdAt: cal.date(byAdding: .day, value: -10, to: now)!, photos: nil, reportLocations: nil),
        ]
    }
}
